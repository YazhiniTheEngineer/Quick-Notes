...
function Input({trigger,setTrigger,name,setName,taskContent,settaskContent,radio,setRadio}){
    ...
    let setAns = (e) => {
        e.preventDefault();
        localStorage.setItem(name,[taskContent,radio]);
        tasks.push([name,taskContent,radio]);
        console.log(tasks)
        setName("");
        settaskContent("");
        setRadio("");
